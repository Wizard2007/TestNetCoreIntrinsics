...
{
    public sealed class XorshiftUnrolled64IntrinsicsVectorsUnroled : Xorshift
    {
        ...
        public XorshiftUnrolled64IntrinsicsVectorsUnroled()
        {
        ...
        protected unsafe override void FillBuffer(byte[] buf, int offset, int offsetEnd)
        {
            fixed(ulong* pxyzwArray = xyzwArray)
            {
                ...
                var x = new Vector<ulong>(xyzwArray, 0);
